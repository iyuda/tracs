        ...
        1: [function (a, d, b) {
            ...
            a.prototype = {
                ...
                create: function () {
                    ...
                    //t.innerHTML = '<div class="smartbanner-container">' +
                    //    '<input style="width:40px;height:40px;" type="image" src="~/images/icon.png" name="btnHome" class="smartbanner-icon" />'+
                    //    '<div class="smartbanner-info"><div class="smartbanner-title">' + this.options.title + "</div><div>" + this.options.author + "</div><span>" + e + '</span></div><a href="' + a + '" class="smartbanner-button"><span class="smartbanner-button-text">' + this.options.button + "</span></a></div>";
