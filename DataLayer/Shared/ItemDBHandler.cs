...
namespace DataLayer
{
    public abstract class ItemDBHandler
    {
        ...
        public ItemDBHandler(int? id, string TableName="", string FieldName="id")
        {
            this.id = id;
            ...
            if (FieldName != "id")
                ...
                this.Retrieve(TableName + FieldName);
        ...
        //public Boolean Retrieve<T>(List<T> DataList)
        //{
        //    try
        //    {
        ...
        //                    string Value = DataList[0][prop.Name].ToString();
        ...
        public bool InsertUpdateAction(int InsertUpdate = 0, string[] WhereColumns = null, string[] WhereValues = null)
        {
            ...
            switch (InsertUpdate)
            {
                case 0:
                    if (Exists())
                        rv = Update(WhereColumns: WhereColumns, WhereValues: WhereColumns);
                    else
                        rv = Insert();
                    break;
                case 1:
        ...
        public bool Save(string[] WhereColumns=null)
        {
            this.SaveChildren();
            return this.InsertUpdateAction(0,WhereColumns);
        }
