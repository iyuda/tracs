...
namespace DataLayer
{
    ...
    public class CompanyDetails : ItemDBHandler
    {
        ...
        public int? CompanyDetailsStateId { get; set; }

        [Display(Name = "CountryId")]
        [DataMember]
        [JsonProperty(PropertyName = "CountryId")]
        public int? CompanyDetailsCountryId { get; set; }
        ...
        {
            parameters.Clear();
            parameters.Add("id", new object[] { this.CompanyDetailsStateId.ToString(), SqlDbType.Int });
